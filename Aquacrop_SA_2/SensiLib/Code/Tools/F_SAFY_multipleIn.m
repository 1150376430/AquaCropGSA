...
%% 
LAI_m(e,:)=LAI;                                                    % LAI: su ogni riga c'è un intero ciclo di LAI (dal giorno della semina alla raccolta) per ogni e-simo "punto dell'iperspazio" (vedi Campolongo et al. 2007) 
Yield_m(e,:)=Yield ;                                    
end

...
if (length(p) == 1 && k~=1)
    p = p*ones(1,k);          % il numero di livelli può variare per ogni fattore d'input. pertanto p dovrà essere un vettore dove ogni elemento i-esimo è il livello dell'i-esimo parametro. 
